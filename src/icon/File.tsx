...
const File: React.FunctionComponent = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.8 482.8" fill="#d11f40" width="60">
      <g>
        <g>
          <path
            d="M431.3,114.5c-1.4-3.3-3.5-6.4-6.1-8.9l-101.9-98c-2.5-2.4-5.4-4.3-8.6-5.6l0,0c-3.2-1.3-6.6-2-10.1-2H109
          ...
          />
          <path
            d="M110,241.5L110,241.5c0,7.7,6.3,14.1,14.1,14.1h237.1c7.7,0,14.1-6.3,14.1-14.1l0,0c0-7.7-6.3-14.1-14.1-14.1H124.1
			C116.3,227.4,110,233.8,110,241.5z"
          />
          <path
            d="M361.1,283.7h-237c-7.7,0-14.1,6.3-14.1,14.1l0,0c0,7.7,6.3,14.1,14.1,14.1h237.1c7.7,0,14.1-6.3,14.1-14.1l0,0
			C375.2,290,368.9,283.7,361.1,283.7z"
          />
          <path
            d="M361.1,340h-237c-7.7,0-14.1,6.3-14.1,14.1l0,0c0,7.7,6.3,14.1,14.1,14.1h237.1c7.7,0,14.1-6.3,14.1-14.1l0,0
			C375.2,346.3,368.9,340,361.1,340z"
          />
          <path
            d="M255.1,396.2H122.9c-7.7,0-14.1,6.3-14.1,14.1s6.3,14.1,14.1,14.1h132.3c7.7,0,14.1-6.3,14.1-14.1
			S262.9,396.2,255.1,396.2z"
          />
          <path
            d="M172.2,201.3h61.9c-0.3-25.7,0.7-39.5-16-45.6c-15.2-5.8-24.2-11.7-24.2-11.7l-11.7,36.9l-1.6,5l-5.2-14.8
          ...
          />
          <path
            d="M145.8,120.6c1.3,8.7,8,19.7,19,23.6c4.5,1.6,9.5,1.6,14,0c10.8-3.9,17.7-14.9,19.1-23.6c1.5-0.1,3.4-2.2,5.4-9.5
