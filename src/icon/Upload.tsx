...
const Upload: React.FunctionComponent = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384.97 384.97" fill="#d11f40" width="14" className="icon">
      <g>
        <g id="Arrow_Up_Circle">
          <path
            d="M192.485,0C86.173,0,0,86.185,0,192.485C0,298.797,86.173,384.97,192.485,384.97c106.3,0,192.485-86.173,192.485-192.485
          ...
          />
          <path
            d="M201.087,75.707c-2.262-2.238-5.426-3.525-8.602-3.525c-3.164,0-6.328,1.299-8.59,3.525l-84.2,82.997
